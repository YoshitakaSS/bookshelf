...

{
    ...
    var reviewTitle = document.getElementById('js-review-title');
    var reviewTitleCount = document.getElementById('js-count-l-title');
    var reviewText = document.getElementById('js-review-text');
    var reviewTextCount = document.getElementById('js-count-l-text');
    ...
    reviewTitle.addEventListener('keyup', () => {
        var titleLength = reviewTitle.value.length;
        reviewTitleCount.textContent = titleLength;
        if (titleLength > 20) {
            reviewTitleCount.classList.add('error-message');
        } else {
            reviewTitleCount.classList.remove('error-message');
        }
    });

    reviewText.addEventListener('keyup', () => {
        var reviewLength = reviewText.value.length;
        reviewTextCount.textContent = reviewLength;
        if (reviewLength > 350) {
            reviewTextCount.classList.add('error-message');
        } else {
            reviewTextCount.classList.remove('error-message');
        }
    });
